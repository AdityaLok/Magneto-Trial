...
exports.config = {
    ...
    // ],
    specs: [
        // './test/specs/01_homePage.e2e.js',
        // './test/specs/02_signupLogin.js',
        './test/specs/03_purchaseProduct.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    // // ✅ Hook to delete allure-results before the test run
    ...
    //     allure.startStep(`Starting: ${test.title}`);
    // },
